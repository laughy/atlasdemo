 ...
 * task:awoCopyDebugSolib
 * dependon:mergeDebugAssets class:MergeSourceSetFolds
 */
public class CopyAwoSolibTask extends BaseTask {
    ...
    public void doFullTaskAction() {
        ...
        File libJniFolder2 = new File(awbBundle.getAndroidLibrary().getFolder(), "jni");
        ...
        File libJniFolder3 = new File(awbBundle.getAndroidLibrary().getFolder(), "jniLibs");
        ...
        List<? extends AndroidLibrary> deps = awbBundle.getAndroidLibraries();
    ...
    public static class ConfigAction extends MtlBaseTaskAction<CopyAwoSolibTask> {
        ...
        @NonNull
        @Override
        public Class<CopyAwoSolibTask> getType() {
