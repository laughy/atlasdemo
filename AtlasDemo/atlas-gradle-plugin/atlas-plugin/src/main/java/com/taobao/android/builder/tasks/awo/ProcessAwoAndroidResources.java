...
/**
 * @author wuzhong
 * task--firstbundle:awoProcessDebugResources
 * before--firstbundle:mergeDebugResource[com.atlas.demo-firstbundle]--|
 * beforeclass--before:com.taobao.android.builder.tasks.app.merge.CachedMergeResources_Decorated
 */
public class ProcessAwoAndroidResources extends IncrementalTask {
    ...
    public static class ConfigAction extends MtlBaseTaskAction<ProcessAwoAndroidResources> {
        ...
        @NonNull
        @Override
        public Class<ProcessAwoAndroidResources> getType() {
            return ProcessAwoAndroidResources.class;
        }
        ...
        public void execute(@NonNull ProcessAwoAndroidResources processResources) {
            ...
            ConventionMappingHelper.map(processResources, "mainSymbolFile", new Callable<File>() {
                ...
                public File call() throws Exception {
                    return new File(libVariantContext.apContext.getApExploredFolder(), "R.txt");
                }
            });
            ...
            processResources.setSourceOutputDir(libVariantContext.getSourceOutputDir());
            ...
            ConventionMappingHelper.map(processResources, "resDir", new Callable<File>() {
                ...
                @Override
                public File call() throws Exception {
                    return libVariantContext.getMergeResources(awbBundle);
                }
            });
            ...
            ConventionMappingHelper.map(processResources, "assetsDir", new Callable<File>() {
                ...
                @Override
                public File call() throws Exception {
                    return libVariantContext.getMergeAssets(awbBundle);
                }
            });

            if (generateResourcePackage) {
                processResources.setPackageOutputFile(libVariantContext.getOutputResouceAP());
            }
